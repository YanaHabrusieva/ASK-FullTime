...
#    Create Assignment
  ...
  Scenario: Login as a student and check if assignment is available
    Given I navigate to "login" page
    When I type email "fshuaib.mustaf@fastboattolembongan.com" on "login" page
    And I type password "12345" on "login" page
    And I click Sign in button
    When I click on My Assignments
    Then Student Assignment page should have quiz "Test Quiz"
    When I click Log out
    And I confirm Log Out
  Scenario: Clean up after the test
    Given I navigate to "login" page
    When I type email "qa.sofi@gmail.com" on "login" page
    And I type password "123456" on "login" page
    And I click Sign in button
    When I click on Assignments on left menu
    Then select quiz "Test Quiz" from Assignments and delete
